...
$dn = date("Y-m-d G:i:s");
	...
	mysqli_query($conn, "INSERT INTO activitylog (personincharge, activity, datetime) VALUES ('$sn', 'Generate barcode for personnels', '$dn')");
...
<?php
	$getpersons = mysqli_query($conn, "SELECT * FROM personincharge");
?>
...
<div class="bodywrapper">
	...
	while($getpersonsrow = mysqli_fetch_array($getpersons)){
		...
		echo bar128(stripcslashes($getpersonsrow['idnum']))."</div></center>";
	}	
	?>
